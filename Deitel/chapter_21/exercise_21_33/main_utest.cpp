...
testList(List<T>& listObject, const std::string& typeName)
{
    ...
    int choice;
    T value;
    int caseInput[9] = {1, 1, 2, 2, 3, 3, 4, 4, 5};
    int ci = 0;
    T valueInput[4] = {static_cast<T>(1.1), static_cast<T>(2.2), static_cast<T>(3.3), static_cast<T>(4.4)};
    int vi = 0;
    do {
        std::cout << "? ";
...
TEST(Stack, Int)
{
    ...
    EXPECT_EQ(lastOutput, "processing an integer Stack\nThe list is: 0 \n\nThe list is: 1 0 \n\nThe list is: 2 1 0 \n\n2 popped from stack\nThe list is: 1 0 \n\n1 popped from stack\nThe list is: 0 \n\n0 popped from stack\nThe list is empty\n\n");
