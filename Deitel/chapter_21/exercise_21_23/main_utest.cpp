...
TEST(Tree, Search)
{
    ...
    EXPECT_EQ(intTree.binarySearchTree(50)->getData(), 50);
    EXPECT_EQ(intTree.binarySearchTree(25)->getData(), 25);
    EXPECT_EQ(intTree.binarySearchTree(75)->getData(), 75);
    EXPECT_EQ(intTree.binarySearchTree(12)->getData(), 12);
    EXPECT_EQ(intTree.binarySearchTree(33)->getData(), 33);
    EXPECT_EQ(intTree.binarySearchTree(67)->getData(), 67);
    EXPECT_EQ(intTree.binarySearchTree(88)->getData(), 88);
    EXPECT_EQ(intTree.binarySearchTree(6)->getData(), 6);
    EXPECT_EQ(intTree.binarySearchTree(13)->getData(), 13);
    EXPECT_EQ(intTree.binarySearchTree(68)->getData(), 68);
    EXPECT_FALSE(intTree.binarySearchTree(24));
    EXPECT_TRUE(intTree.binarySearchTree(25));
}
